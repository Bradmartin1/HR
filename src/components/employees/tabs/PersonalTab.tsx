        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-4 sm:grid-cols-3">
            {canViewSensitive && (
              <>
                <div>
                  <dt className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">Date of Birth</dt>
                  <dd className="mt-1 text-sm">{formatDate(employee.date_of_birth)}</dd>
                </div>
                <div>
                  <dt className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">Gender</dt>
                  <dd className="mt-1 text-sm capitalize">{employee.gender ?? "—"}</dd>
                </div>
                <div>
                  <dt className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">Ethnicity</dt>
                  <dd className="mt-1 text-sm capitalize">{employee.ethnicity ?? "—"}</dd>
                </div>
              </>
            )}
            <div>
              <dt className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">Personal Email</dt>
              <dd className="mt-1 text-sm">{employee.personal_email ?? "—"}</dd>
            </div>
            <div>
              <dt className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">Personal Phone</dt>
      ...
      <Card>
        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-4 sm:grid-cols-3">
            ...
            <div>
              <dt className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">Relationship</dt>
              <dd className="mt-1 text-sm capitalize">{employee.emergency_contact_rel ?? "—"}</dd>
            </div>
            <div>
